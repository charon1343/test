...
BEGIN_MESSAGE_MAP(CMFC_TEST1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_CHECKBOX, &CMFC_TEST1Dlg::OnBnClickedCheckbox)
	ON_BN_CLICKED(IDC_PROGRESS, &CMFC_TEST1Dlg::OnBnClickedProgress)
END_MESSAGE_MAP()


// CMFC_TEST1Dlg 메시지 처리기
...
void CMFC_TEST1Dlg::OnBnClickedCheckbox()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	dlg_checkbox.DoModal();

}


void CMFC_TEST1Dlg::OnBnClickedProgress()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
